          ...
          <div className="project-modal">
            ...
            <div className="modal-section">
              ...
              <div className="preview-box">
                <p>Add project images here later.</p>
              </div>
            </div>

            <div className="modal-actions">
              <a href={selectedProject.sourceCode} target="_blank" rel="noreferrer">
                Source Code
              </a>
              <a href={selectedProject.demoVideo} target="_blank" rel="noreferrer">
                Demo Video
              </a>
            </div>
          </div>
